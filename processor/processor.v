...
module processor(
    ...
    wire [31:0] dataA;
	 ...
	 //choose first input
	  ...
	  wire [1:0] notBranchA, notBranchB, muxBranchA, muxBranchB;
    ...
    // D/X latch
	 ...
	 //execute stage 
	  ...
	  wire [31:0] ALU_dataB, ALU_dataB1,  ALU_dataA;
